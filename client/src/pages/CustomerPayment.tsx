            ...
            <div className="bg-gradient-to-r from-teal-600 to-teal-800 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden group">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-6xl md:text-7xl font-black tracking-tighter">{displayDue.toFixed(0)}</span>
                    </div>
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div>
                                                <div className="flex items-center gap-2 mb-1">
                                                    <span className="text-xl font-black text-gray-800 tracking-tight">₹{payment.amount.toFixed(0)}</span>
